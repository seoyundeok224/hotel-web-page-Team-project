...
import { Container, Box, TextField, Button, Typography, Alert, CircularProgress, InputAdornment, Link } from '@mui/material';
...
            <Typography>
              당신의 아이디는&nbsp;
              <Link component={RouterLink} to={`/login?username=${result}`} underline="hover" color="inherit" sx={{ fontWeight: 'bold' }}>
                {result}
              </Link>
              &nbsp;입니다.
            </Typography>
